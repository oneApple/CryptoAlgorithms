...
if __name__ == '__main__':
    ...
    s1 = e1.EncryptoList(e2.EncryptoList(StringToList("message12345678901234567890")))
    s2 = e2.EncryptoList(e1.EncryptoList(StringToList("message12345678901234567890")))
